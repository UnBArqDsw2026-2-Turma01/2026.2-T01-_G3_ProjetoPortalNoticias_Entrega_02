...
<figure style="text-align: center;">
        ...
        <img src="../../../assets/subGrupo3/estatico_componentes_final.png"
            alt="Diagrama de Componentes - Burburinho" style="max-width: 100%;">
...
<figure style="text-align: center;">
        ...
        <img src="../../../assets/subGrupo3/diagrama_componentes_johnn.png"
            alt="Diagrama de Componentes - Burburinho (Johnnatan)" style="max-width: 100%;">
...
<figure style="text-align: center;">
        ...
        <img src="../../../assets/subGrupo3/dinamico_estados_final.png"
            alt="Máquina de Estados - Ciclo de Vida da Sugestão de Pauta" style="max-width: 100%;">
...
<figure style="text-align: center;">
        ...
        <img src="../../../assets/subGrupo3/diagrama_estados_johnn.png"
            alt="Máquina de Estados - Ciclo de Vida da Publicação" style="max-width: 100%;">
